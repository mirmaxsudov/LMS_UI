  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{pendingCount} items need attention across your children</CardDescription>
      </CardHeader>
          ...
          return (
            ...
            >
              ...
              <div className='flex shrink-0 items-center gap-2'>
                ...
                <Badge
                  style={{
                    backgroundColor: `${assignment.childColor}1f`,
                    color: assignment.childColor
                  }}
                  className='border-0'
                >
