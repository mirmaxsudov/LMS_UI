...
const Sidebar = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className='bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col px-4 group-data-[state=collapsed]:px-2 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm'
          data-sidebar='sidebar'
...
const SidebarTrigger = ({ onClick, children, ...props }: React.ComponentProps<typeof Button>) => {
  ...
  return (
    ...
    >
      {children ??
        ((isMobile ? openMobile : open) ? <PanelLeftCloseIcon /> : <PanelLeftOpenIcon />)}
...
const SidebarHeader = ({ className, ...props }: React.ComponentProps<'div'>) => {
  return (
    <div
      className={cn('flex flex-col gap-2 border-b py-2', className)}
      data-sidebar='header'
